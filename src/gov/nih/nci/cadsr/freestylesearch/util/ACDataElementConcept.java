...
// $Header: /share/content/gforge/freestylesearch/freestylesearch/src/gov/nih/nci/cadsr/freestylesearch/util/ACDataElementConcept.java,v 1.1 2006-06-30 13:46:47 hebell Exp $
...
public class ACDataElementConcept extends GenericAC
{
    ...
    public String getDisplay(int score_)
    {
        ...
        + "'\n\tScore " + score_
        + "' from sbr.data_element_concepts_view zz, sbr.ac_registrations_view rs, sbr.contexts_view cc "
        + "where zz.dec_idseq = ? and cc.conte_idseq = zz.conte_idseq and rs.ac_idseq(+) = zz.dec_idseq";
    }
