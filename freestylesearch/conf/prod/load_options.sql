/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /share/content/gforge/freestylesearch/freestylesearch/conf/prod/load_options.sql,v 1.5 2007-05-29 18:12:11 hebell Exp $
...
merge into sbrext.tool_options_view_ext s
using (
          select 'FREESTYLE' as tool_name , 'URL' as property, 'http://freestyle.nci.nih.gov' as value, '' as ua_name, 'The URL to the Freestyle Search Engine browser interface.' as description from dual
